...
class DataSpeech():
    ...
    def load_datalist(self):
        if self.type == 'train':
            filename_wavlist_thchs30 = 'train.wav.lst'
            filename_symbollist_thchs30 = 'train.syllable.txt'
        elif self.type == 'dev':
            filename_wavlist_thchs30 = 'cv.wav.lst'
            filename_symbollist_thchs30 = 'cv.syllable.txt'
        elif self.type == 'test':
            filename_wavlist_thchs30 = 'test.wav.lst'
            filename_symbollist_thchs30 = 'test.syllable.txt'
        else:
            pass
    ...
    def data_generator(self, batch_size=8, audio_length=1600):
        ...
        while True:
            X = np.zeros([batch_size , audio_length, 200, 1] , dtype=np.float)
            y = np.zeros([batch_size , 96] , dtype=np.int16)
...
if __name__ == '__main__':
    datapath = '/home/zhangwei/PycharmProjects/ASR_Thchs30/data_list_phone/'
